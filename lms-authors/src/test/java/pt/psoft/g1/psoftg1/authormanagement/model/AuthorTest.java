...
class AuthorTest {
    ...
    private final UpdateAuthorRequest request = new UpdateAuthorRequest(1L, validName, validBio, null, null);
    ...
    void whenVersionIsStaleItIsNotPossibleToPatch() {
        ...
        assertThrows(StaleObjectStateException.class, () -> subject.applyPatch(999, "Diogo", "Bio do Diogo", null));
    }
